...
export function ts_query_is_pattern_non_local(a: number, b: number): number;
...
export function ts_tree_cursor_goto_first_child_internal(a: number): number;
export function ts_tree_cursor_goto_sibling_internal(a: number, b: number): number;
export function ts_query_cursor_remove_match(a: number, b: number): void;
export function ts_query_cursor_set_max_start_depth(a: number, b: number): void;
...
export function ts_parser_print_dot_graphs(a: number, b: number): void;
...
export function ts_language_next_state(a: number, b: number, c: number): number;
...
export function ts_node_language(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function ts_node_grammar_symbol(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function ts_node_grammar_type(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function ts_node_is_error(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function ts_node_descendant_count(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function ts_node_parse_state(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function ts_node_next_parse_state(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function ts_tree_included_ranges(a: number, b: number): number;
...
export function ts_language_state_count(a: number): number;
...
export function ts_lookahead_iterator_new(a: number, b: number): number;
export function ts_lookahead_iterator_delete(a: number): void;
export function ts_lookahead_iterator_reset_state(a: number, b: number): number;
export function ts_lookahead_iterator_reset(a: number, b: number, c: number): number;
export function ts_lookahead_iterator_next(a: number): number;
export function ts_lookahead_iterator_current_symbol(a: number): number;
export function ts_lookahead_iterator_current_symbol_name(a: number): number;
export function ts_lookahead_iterator_language(a: number): number;
...
export function ts_tree_cursor_goto_last_child_internal(a: number): number;
export function ts_tree_cursor_goto_descendant(a: number, b: number): void;
export function ts_tree_cursor_goto_previous_sibling_internal(a: number): number;
...
export function ts_tree_cursor_goto_last_child(a: number): number;
...
export function ts_tree_cursor_goto_next_sibling_internal(a: number): number;
export function ts_tree_cursor_goto_next_sibling(a: number): number;
export function ts_tree_cursor_goto_previous_sibling(a: number): number;
export function ts_tree_cursor_goto_parent(a: number): number;
export function ts_tree_cursor_current_descendant_index(a: number): number;
export function ts_tree_cursor_current_depth(a: number): number;
...
export function ts_tree_cursor_reset_to(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb1aa4a92b561353d(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6e3dd863b7fa0162(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h63de4e87b2b130ad(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9f2e11b936bdf826(a: number, b: number, c: number): void;
